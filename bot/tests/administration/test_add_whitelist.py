...
class TestWhitelistCommands(BaseTest):
    ...
    def test_add_and_remove_valid_user_whitelist(self):
        add_response = self.send_command('/addwhitelist 123456789') #TODO addwhitelist to jest rozjebana komenda XD
    ...
    def test_add_whitelist_invalid_user_id_format(self):
        add_response = self.send_command('/addwhitelist user123') #TODO addwhitelist to jest rozjebana komenda XD
    ...
    def test_remove_nonexistent_user_whitelist(self):
        ...
        remove_expected_fragments = ["✅ Usunięto 888888888 z whitelisty.✅"] #TODO to też jest torchę rozjebane bo można
                                                                                            # usuwać to czego nie ma XD
        self.assert_response_contains(remove_response, remove_expected_fragments)
