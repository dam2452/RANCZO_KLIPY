...
class TestRemoveWhitelistCommand(BaseTest):
    ...
    def test_remove_existing_user_whitelist(self):
        add_response = self.send_command('/addwhitelist 6967485026') #TODO To jest rozjebana komenda tak samo jak remove
    ...
    def test_remove_nonexistent_user_whitelist(self):
        remove_response = self.send_command('/removewhitelist 6967485026') #TODO To jest rozjebana komenda
        remove_expected_fragments = ["✅ Usunięto 6967485026 z whitelisty.✅"]
        self.assert_response_contains(remove_response, remove_expected_fragments)

    @pytest.mark.long
    def test_remove_user_whitelist_twice(self):
        add_response = self.send_command('/addwhitelist 123456789') #TODO To jest rozjebana komenda
        add_expected_fragments = ["Użytkownik o ID 123456789 został dodany do whitelisty."]
        self.assert_response_contains(add_response, add_expected_fragments)

        first_remove_response = self.send_command('/removewhitelist 123456789') #TODO To jest rozjebana komenda
        ...
        second_remove_response = self.send_command('/removewhitelist 123456789') #TODO To jest rozjebana komenda
